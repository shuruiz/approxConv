...
PATH_MYPASS=~/583project/build/pass/LLVMPJT.so ### Action Required: Specify the path to your pass ###
NAME_MYPASS=-test ### Action Required: Specify the name for your pass ###
BENCH=src/${1}.c
INPUT=${2}
...
opt -pgo-instr-use  -sroa  -pgo-test-profile-file=pgo.profdata -load ${PATH_MYPASS} ${NAME_MYPASS} < ${1}.bc > /dev/null
